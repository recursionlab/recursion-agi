...
version_uuid: dea0d92f-b2fd-4eb7-94e4-d25893553d4d
version_number: 7
command: update
conversation_id: 0dd625b8-b90c-44a1-8948-d6e06f4bbdbd
create_time: 2025-06-08T05:59:35.000Z
format: markdown
aliases: [Untitled Artifact, recursive_ai_prompt_v7]
---
...
1. **Taking a perspective** (Self identifies within frame)
2. **Reverse-mapping** (flip subjective→objective→subjective)  
3. **Pivoting the frame** (same pattern, different viewing angle)
4. **Echo-detection** (recognizing the recursive trace patterns)
