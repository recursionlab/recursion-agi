...
version_uuid: 1d9b8a1d-74bc-41cf-953e-104c82c13552
version_number: 1
command: create
conversation_id: 63431f64-18ff-48ef-9624-189a352b0bb7
create_time: 2025-07-25T07:46:43.000Z
format: jsx
aliases: [PDF Artifact Crafter, pdf-crafter_v1]
---

# PDF Artifact Crafter (Version 1)
...
const PDFCrafter = () => {
  ...
  const ArtifactCard = ({ artifact, onClick, isSmall = false }) => (
    <div
      className={`
        ${isSmall ? 'p-3' : 'p-4'} rounded-lg border-2 cursor-pointer transition-all duration-300
